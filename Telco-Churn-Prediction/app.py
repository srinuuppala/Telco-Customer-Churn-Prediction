...
@st.cache_resource
def load_artifacts():
    model_path = r"Telco-Churn-Prediction/churn_xgb_model.pkl"
    scaler_path = r"Telco-Churn-Prediction/scaler.pkl"
    cols_path = r"Telco-Churn-Prediction/feature_columns.pkl"
